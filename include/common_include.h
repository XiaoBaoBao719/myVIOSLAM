#pragma once
#ifndef MYVIOSLAM_COMMON_INCLUDE_H
#define MYVIOSLAM_COMMON_INCLUDE_H

/**
 * @brief List of commonly used headers and libs so we don't need to repeat a long list
 * 
 */
...
// definitions from the Eigen lib thatll be useful
